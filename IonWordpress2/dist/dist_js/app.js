...
'your_app_name.factories', 'ngCordova', 'auth0', 'angular-storage', 'angular-jwt'])
...
.config(['$stateProvider', '$urlRouterProvider', 'authProvider', '$httpProvider', 'jwtInterceptorProvider', function($stateProvider, $urlRouterProvider, authProvider, $httpProvider,
...
;
  ...
  $urlRouterProvider.otherwise('/app/home');
    ...
    // Configure Auth0
  authProvider.init({
    domain: 'brandecho.auth0.com',
    clientID: 'QihNq02WTJsEkZ2rNwJQOFJgVOg8P4s9',
    loginState: 'login'
  });
...
.controller('AuthLoginCtrl', ['$scope', '$state', '$ionicLoading', 'AuthService', 'PushNotificationsService', function($scope, $state, $ionicLoading, AuthService, PushNotificationsService) {
  $scope.user = {};
...
.constant('WORDPRESS_API_URL', 'http://www.brandechomedia.com/wp/api/')
.constant('WORDPRESS_PUSH_URL', 'http://www.brandechomedia.com/wp/api/')
.constant('GCM_SENDER_ID', '30879657255')
